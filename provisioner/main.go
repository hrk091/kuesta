...
import (
	...
	watcherv1alpha1 "github.com/hrk091/nwctl/provisioner/api/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cb43426e.hrk091.dev",
	})
	if err != nil {
	...
	if err = (&controllers.DeviceRolloutReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "DeviceRollout")
		os.Exit(1)
	}
